                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-select col-12" id="inlineFormCustomSelect">
                        ...
                        <label for="tb-fname">Categoria</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-select col-12" id="inlineFormCustomSelect">
                        ...
                        <label for="tb-fname">Cliente</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        ...
                        <label for="tb-fname">Link externo</label>
                      </div>
                    </div>
