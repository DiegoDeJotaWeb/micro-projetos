      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-md-5 align-self-center">
            <h3 class="page-title">Cadastrar ordem de serviço</h3>
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        <select class="form-select col-12" id="inlineFormCustomSelect">
                          ...
                          <option value="2">Jhenny</option>
                        </select>
                       
                        <label for="tb-fname">Nome cliente</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="date" class="form-control" id="tb-fname" placeholder="Enter Name here" />
                        <label for="tb-fname">Data da fatura</label>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="date" class="form-control" id="tb-fname" placeholder="Enter Name here" />
                        <label for="tb-fname">Data de vencimento</label>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="form-floating mb-3">
                      <select class="form-select col-12" id="inlineFormCustomSelect">
                          <option>Selecione</option>
                          <option value="1">Desenvolvimento de site</option>
                          <option value="2">Cartão de visita</option>
                          <option value="3">Sistema de contatos</option>
                        </select>
                        <label for="tb-fname">Serviço</label>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="tb-fname" placeholder="Enter Name here" />
                        <label for="tb-fname">Quantidade</label>
                      </div>
                    </div>
                    <div class="col-md-1">
                    <div class="form-floating mb-3">
                      <button class="form-control btn btn-info " style="padding-top: 10px;background:var(--bs-info)!important;font-size:20px;color:var(--bs-white)">+</button>
                    </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tb-fname" value="R$ 3.872,00" placeholder="Enter Name here" />
                        <label for="tb-fname">Valor</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tb-fname"  placeholder="Enter Name here" />
                        <label for="tb-fname">Desconto</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tb-fname" value="R$ 3.872,00"  placeholder="Enter Name here" />
                        <label for="tb-fname">Valor com desconto</label>
                      </div>
                    </div>
...
<div class="col-md-4">
                    ...
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="file" class="form-control" id="tb-fname" placeholder="Enter Name here" />
