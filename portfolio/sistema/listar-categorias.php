...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
                ...
                <table class="
                  ...
                  <tbody>
                    ...
                    while ($linha = $query->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      echo "<td class='title'>
        <a class='link' href='javascript:void(0)'>{$linha['idCategoria']}</a>
      </td>";

                      echo "<td class='title'>
          <a class='link' href='javascript:void(0)'>{$linha['nomeCategoria']}</a>
        </td>";

                      echo "<td>

                      <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editarModal' onclick='editar({$linha['idCategoria']},";
      ...
      |
      <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#apagarModal' onclick='apagar({$linha['idCategoria']})'>
