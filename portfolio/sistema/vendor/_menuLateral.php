         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <li class="sidebar-item">
                     ...
                     <ul aria-expanded="false" class="collapse first-level">
                         <li class="sidebar-item">
                             <a href="cadastro-usuario.php" class="sidebar-link"><i class="mdi mdi-email"></i><span class="hide-menu"> Cadastro de usuario </span></a>
                         </li>
                         <li class="sidebar-item">
                         ...
                         <li class="sidebar-item">
                             <a href="cadastro-cliente.php" class="sidebar-link"><i class="mdi mdi-email"></i><span class="hide-menu"> Cadastro de produto </span></a>
                         </li>
                         <li class="sidebar-item">
                             <a href="cadastro-cliente.php" class="sidebar-link"><i class="mdi mdi-email"></i><span class="hide-menu"> Cadastro de fornecedor </span></a>
                         </li>
                         <li class="sidebar-item">
                             <a href="cadastro-cliente.php" class="sidebar-link"><i class="mdi mdi-email"></i><span class="hide-menu"> Cadastro de fabricante </span></a>
                         </li>
