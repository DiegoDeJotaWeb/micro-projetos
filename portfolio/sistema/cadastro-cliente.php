      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-md-5 align-self-center">
            <h3 class="page-title">Cadastrar de cliente</h3>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form method="POST" action="vendor/cliente.php">
                  <div class="row">


                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="text" name="nomeCliente" class="form-control" id="tb-fname" placeholder="Enter Name here">
                        <label for="tb-fname">Nome Empresa</label>
                      </div>
                    </div>

                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="text" name="representanteCliente" class="form-control" id="tb-fname" placeholder="Enter Name here">
                        <label for="tb-fname">Nome representante</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" name="telefoneCliente" class="form-control" id="tb-fname" placeholder="Enter Name here">
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" name="emailCliente" class="form-control" id="tb-fname" placeholder="Enter Name here">
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="file" name="imagemCliente" class="form-control" id="tb-fname" placeholder="Enter Name here">
                    ...
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        <textarea name="descricaoCliente" class="form-control" id="" cols="30" rows="10"></textarea>
