          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="./vendor/cadastro/_cadastroMaterial.php" method="POST" id="formMaterial">
                  <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="valorPacoteMaterial" name="valorPacoteMaterial" onkeyup="getVal()" />
                        <label for="tb-fname">Valor total</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="quantidadeMaterial" name="quantidadeMaterial" onkeyup="getVal()" />
                        <label for="tb-fname">Quantidade</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="valorUnitarioMaterial" name="valorUnitarioMaterial" readonly />
