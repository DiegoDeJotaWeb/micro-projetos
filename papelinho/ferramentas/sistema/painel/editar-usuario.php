  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-md-5 align-self-center">
            <h3 class="page-title">Cadastrar usuario </h3>
      ...
      <div class="container-fluid">
        ...
        $query = $pdo->query("SELECT * FROM tb_usuario WHERE idUsuario = $idUsuario");
        ...
        ?>
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Cadastro</h4>
                  <form action="./vendor/editar/_editarUsuario.php" method="POST" enctype='multipart/form-data'>
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" placeholder="" name="nomeUsuario" value="<?php echo $linha['nomeUsuario']; ?>" />
                          <label for="tb-fname">Nome</label>
                        </div>
                      </div>

                      <input type="hidden" class="form-control" placeholder="" name="idUsuario" value="<?php echo $linha['idUsuario']; ?>" />

                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="date" class="form-control" name="dtNascimentoUsuario" value="<?php echo $linha['dtNascimentoUsuario']; ?>" />
                          <label for="tb-fname">Data de nascimento</label>
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="cpfUsuario" value="<?php echo $linha['cpfUsuario']; ?>" />
                          <label for="tb-fname">CPF</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="rgUsuario" value="<?php echo $linha['rgUsuario']; ?>" />
                          <label for="tb-fname">RG</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="emailUsuario" value="<?php echo $linha['emailUsuario']; ?>" />
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="telefoneUsuario" value="<?php echo $linha['telefoneUsuario']; ?>" />
                          <label for="tb-fname">Telefone</label>
                        </div>
                      </div>

                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="celularUsuario" value="<?php echo $linha['celularUsuario']; ?>" />
                          <label for="tb-fname">Celular</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="date" class="form-control" name="dtAdmissaoUsuario" value="<?php echo $linha['dtAdmissaoUsuario']; ?>" />
                          <label for="tb-fname">Data de admissão</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          ...
                          <select class="form-select col-12" name="cargoUsuario" value="<?php echo $linha['cargoUsuario']; ?>">
                            <?php
                            require_once "./vendor/_conexao.php";

                            $query1 = $pdo->query("SELECT  * FROM tb_cargo");
                            ...
                            ?>
                              ...
                              <option value="<?php echo $linha1['nomeCargo'] ?>" <?php
                                                                                  if ($linha1['idCargo'] == $linha['cargoUsuario']) {
                                                                                    echo "selected";
                                                                                  }
                                                                                  ?>><?php echo $linha1['nomeCargo'] ?></option>
                          ...
                          <label for="tb-fname">Cargo</label>
                        </div>
                      </div>

                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <select class="form-select col-12" name="adminUsuario">
                            <option value="Não"  <?php if ($linha['adminUsuario'] == "Não") {
                               echo "selected";
                                                                                }
                              ?> >Não</option>
                            <option value="Sim" <?php if ($linha['adminUsuario'] == "Sim") {
                               echo "selected";
                                                                                }
                              ?> >Sim</option>
                          ...
                          <?php
           echo $linha['tipoContaUsuario'] ;
           ?>         

                          <label for="tb-fname">Admin</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="bancoUsuario" value="<?php echo $linha['bancoUsuario']; ?>" />
                          <label for="tb-fname">Banco</label>
                        </div>
                      </div>

                      <div class="col-md-3">
                        <div class="form-floating mb-3">
                          <select class="form-select col-12" name="tipoContaUsuario">
                            <option value="Corrente"  
                            <?php if ($linha['tipoContaUsuario'] == "Corrente") {
                               echo "selected";
                                                                                }
                              ?>>Corrente</option>
                            <option value="Poupança" <?php if ($linha['tipoContaUsuario'] == "Poupança") {
                               echo "selected";
                                                                                }
                              ?>>Poupança</option>
                          </select>
                          <label for="tb-fname">Tipo</label>
                        </div>
                      </div>

                      <div class="col-md-3">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="contaUsuario" value="<?php echo $linha['contaUsuario']; ?>" />
                          <label for="tb-fname"> Conta</label>
                        </div>
                      </div>

                      <div class="col-md-3">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="agenciaUsuario" value="<?php echo $linha['agenciaUsuario']; ?>" />
                          <label for="tb-fname"> Agencia</label>
                        </div>
                      </div>

                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="pixUsuario" value="<?php echo $linha['pixUsuario']; ?>" />
                          <label for="tb-fname">Chave PIX</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="cepUsuario" value="<?php echo $linha['cepUsuario']; ?>" />
                          <label for="tb-fname">CEP</label>
                        </div>
                      </div>

                      <div class="col-md-8">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="enderecoUsuario" value="<?php echo $linha['enderecoUsuario']; ?>" />
                          <label for="tb-fname">Endereço</label>
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="bairroUsuario" value="<?php echo $linha['bairroUsuario']; ?>" />
                          <label for="tb-fname"> Bairro</label>
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" name="cidadeUsuario" value="<?php echo $linha['cidadeUsuario']; ?>" />
                          <label for="tb-fname">Cidade</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="file" class="form-control" name="fotoUsuario" value="<?php echo $linha['fotoUsuario']; ?>" />
                          <label for="tb-fname">Foto</label>
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="password" class="form-control" name="senhaUsuario" value="<?php echo $linha['senhaUsuario']; ?>" />
                          <label for="tb-fname">Senha</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <textarea name="observacaoUsuario" class="form-control" id="" cols="30" rows="10" value=""><?php echo $linha['observacaoUsuario']; ?></textarea>
                          <label for="tb-fname">Observação</label>
                        </div>
                      </div>
