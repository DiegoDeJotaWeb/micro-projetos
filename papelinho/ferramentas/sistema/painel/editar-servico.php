  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        $idServico = $_GET['servicoId'];
        $query = $pdo->query("SELECT * FROM tb_servico WHERE idServico = $idServico");
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="./vendor/editar/_editarServico.php" method="POST" enctype='multipart/form-data'>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <input type="text" name="nomeServico" class="form-control" id="tb-fname" placeholder="" value="<?php echo $linha['nomeServico']; ?>" />
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="text" name="valorServico" class="form-control" id="tb-fname" placeholder="" value="<?php echo $linha['valorServico']; ?>" />
                          <label for="tb-fname">Valor</label>
                        </div>
                      </div>

                      <input type="hidden" name="idServico" value="<?php echo $linha['idServico']; ?>">

                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <select class="form-select col-12" name="horasServico" id="inlineFormCustomSelect" value="<?php echo $linha['horaServico']; ?>">

                            <?php
                            $query1 = $pdo->query("SELECT DISTINCT  quantidadeHora FROM tb_hora");
                            ?>
                            ...
                            ?>
                              ...
                              <option value="<?php echo $linha1['quantidadeHora'] ?>" 
                              <?php
                                if ($linha1['quantidadeHora'] == $linha['horaServico']) {
                                  echo "selected";
                                }
                              ?>  ><?php echo $linha1['quantidadeHora'] ?></option>

                            <?php } ?>
                          </select>
                          <label for="tb-fname">Quantas horas</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-floating mb-3">
                          <input type="file" name="imagemServico" class="form-control" id="tb-fname" placeholder="" value="teste.jpg" />
                          <label for="tb-fname">Imagem</label>
                        </div>
                      </div>

                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <textarea name="descricaoServico" class="form-control" id="" cols="30" rows="10"><?php echo $linha['descricaoServico']; ?></textarea>
                      ...
                      <div class="col-12">
                        <div class="d-md-flex align-items-center mt-3">
                          ...
                          <div class="ms-auto mt-3 mt-md-0">
                            <a href="listar-servicos.php" class=" btn btn-info ">
                              <div class="d-flex align-items-center">
