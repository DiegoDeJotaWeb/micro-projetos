          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="./vendor/cadastro/_cadastroUsuario.php" method="POST" enctype='multipart/form-data'>
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control"  placeholder="" name="nomeUsuario"/>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="date" class="form-control" name="dtNascimentoUsuario"/>
                    ...
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="rgUsuario" />
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="telefoneUsuario"/>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="celularUsuario"/>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="date" class="form-control" name="dtAdmissaoUsuario"/>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <select class="form-select col-12" name="cargoUsuario">
                          <option></option>
                          <?php
                  require_once "./vendor/_conexao.php";
...
FROM tb_cargo");
                  ...
                  <tbody>
                    ...
                    <div class="col-md-3">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="bancoUsuario"/>
                    ...
                    <div class="col-md-3">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="contaUsuario" />
                    ...
                    <div class="col-md-3">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="agenciaUsuario" />
                    ...
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="pixUsuario" />
...
<div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="cepUsuario"/>
                    ...
                    <div class="col-md-8">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="enderecoUsuario"/>
                    ...
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="bairroUsuario"/>
                    ...
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="cidadeUsuario"/>
                    ...
                    <div class="col-md-6">
                      <div class="form-floating mb-3">
                        <input type="file" class="form-control" name="fotoUsuario" />
                    ...
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        <textarea name="observacaoUsuario" class="form-control" id="" cols="30" rows="10"></textarea>
