...
FROM tb_material");
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $linha['idMaterial'] ?></td>


                        <td class="title">
                          <a class="link" href="javascript:void(0)"><?php echo $linha['nomeMaterial'] ?></a>
                        </td>

                        <td class="title">
                          <a class="link" href="javascript:void(0)"><?php echo $linha['valorMaterial'] ?></a>
                        </td>

                        <td class="title">
                          <a class="link" href="javascript:void(0)"><?php echo $linha['valorUnitMaterial'] ?></a>
                        </td>

                        <td class="title">
                          <a class="link" href="javascript:void(0)"><?php echo $linha['quantidadeMaterial'] ?></a>
                        </td>


                        <td>

                          <a href="editar-material.php?materialId=<?php echo $linha['idMaterial']?>"><i class=" fas fa-edit"></i> </a>
                          |
                          <i class="fas fa-trash-alt" data-bs-toggle="modal" data-bs-target="#apagarMaterial" onclick="apagar('<?php echo $linha['idMaterial'] ?>','<?php echo $linha['nomeMaterial'] ?>')"></i>
                        </td>
                      </tr>
      ...
      <!-- Modal -->
      <div class="modal fade" id="apagarMaterial" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>O material <span id="nome-conf-apagar"></span> será removido e essa ação não podera ser revertida!</p>
              <p>Confirmar remoção.</p>
            </div>
            <div class="modal-footer">
              <form action="vendor/excluir/_excluirMaterial.php" method="POST">
                <input type="hidden" name="idMaterialApagar" id="idMaterialApagar">
      ...
      <script>
        function apagar(id, nome) {
          ...
          document.getElementById('idMaterialApagar').value = id;
