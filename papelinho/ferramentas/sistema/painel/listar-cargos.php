...
FROM tb_cargo");
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $linha['idCargo'] ?></td>


                        <td class="title">
                          <a class="link" href="javascript:void(0)"><?php echo $linha['nomeCargo'] ?></a>
                        </td>

                        <td>

                          <a href="editar-cargo.php?cargoId=<?php echo $linha['idCargo']?>"><i class=" fas fa-edit"></i> </a>
                          |
                          <i class="fas fa-trash-alt" data-bs-toggle="modal" data-bs-target="#apagarCargo" onclick="apagar('<?php echo $linha['idCargo'] ?>','<?php echo $linha['nomeCargo'] ?>')"></i>
                        </td>
                      </tr>
      ...
      <!-- Modal -->
      <div class="modal fade" id="apagarCargo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <form action="vendor/excluir/_excluirCargo.php" method="POST">
                <input type="hidden" name="idCargoApagar" id="idCargoApagar">
      ...
      <script>
        function apagar(id, nome) {
          ...
          document.getElementById('idCargoApagar').value = id;
