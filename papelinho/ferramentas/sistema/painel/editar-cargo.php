      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            ...
            $idCargo = $_GET['cargoId'];


            $query = $pdo->query("SELECT * FROM tb_cargo WHERE idCargo = $idCargo");
            ?>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="./vendor/editar/_editarCargo.php" method="POST">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        ...
                        ?>
                          ...
                          <input type="text" class="form-control" name="nomeCargo" value="<?php echo $linha['nomeCargo']; ?>" />

                       

                        <input type="hidden" name="idCargo" value="<?php echo $linha['idCargo']; ?>">
                        <?php
                        }
                        ?>
                        <label for="tb-fname">Nome do cargo</label>
                      </div>
                    </div>
