      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            ...
            $idMaterial = $_GET['materialId'];


            $query = $pdo->query("SELECT * FROM tb_material WHERE idMaterial = $idMaterial");
            ?>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="./vendor/editar/_editarMaterial.php" method="POST">
                <div class="row">
                <?php
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="nomeMaterial" value="<?php echo $linha['nomeMaterial']; ?>" />
                        <input type="hinner" class="form-control" name="idMaterial" value="<?php echo $linha['idMaterial']; ?>" />
                        <label for="tb-fname">Nome material</label>
                      </div>

                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="valorPacoteMaterial" name="valorPacoteMaterial" onkeyup="getVal()" value="<?php echo $linha['valorMaterial']; ?>" />
                        <label for="tb-fname">Valor total</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="quantidadeMaterial" name="quantidadeMaterial" onkeyup="getVal()" value="<?php echo $linha['quantidadeMaterial']; ?>"/>
                        <label for="tb-fname">Quantidade</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="valorUnitarioMaterial" name="valorUnitarioMaterial" readonly  value="<?php echo $linha['valorUnitMaterial']; ?>"/>
                        <label for="tb-fname">Valor unitario</label>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-12">
                      <div class="d-md-flex align-items-center mt-3">
                        ...
                        <a href="listar-cargos.php" type="submit" class=" btn btn-info ">
                            <div class="d-flex align-items-center">
        ...
        <script>
                    function getVal() {
                      var valorPacote = document.getElementById("valorPacoteMaterial").value;
                      var quantidade = document.getElementById("quantidadeMaterial").value;
                      var calcValorUnitario = valorPacote / quantidade;
                      document.getElementById("valorUnitarioMaterial").value = calcValorUnitario.toFixed(2);
                    }
                  </script>
