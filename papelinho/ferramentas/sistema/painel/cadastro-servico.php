          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="vendor/cadastro/_cadastroServico.php" method="POST" enctype='multipart/form-data'>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        <input type="text" name="nomeServico" class="form-control" id="tb-fname" placeholder="" />
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="text" name="valorServico" class="form-control" id="tb-fname" placeholder="" />
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                      <select class="form-select col-12" name="qtdHoraServico" id="inlineFormCustomSelect">
                          <option></option>
                    ...
                    <div class="col-md-4">
                      <div class="form-floating mb-3">
                        <input type="file" name="imagemServico" class="form-control" id="tb-fname" placeholder="" />
                    ...
                    <div class="col-md-12">
                      <div class="form-floating mb-3">
                        <textarea name="descricaoServico" class="form-control" id="" cols="30" rows="10"></textarea>
