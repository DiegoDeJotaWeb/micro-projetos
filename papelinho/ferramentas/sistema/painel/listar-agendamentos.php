  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-md-5 align-self-center">
            <h3 class="page-title">Lista de agendamento</h3>
          ...
          <div class="
            ...
            <div class="d-flex">
              ...
              <a href="cadastro-servico.php" class="btn btn-success">
      ...
      <div class="container-fluid">
              ...
              <div class="card-body">
                ...
                <table class="
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $linha['idAgendamento']?></td>
                        <td class="title">
                          <a class="link" href="javascript:void(0)"><?php echo $linha['nomeCliente']?></a>
                        </td>
                        
                        <td><?php echo $linha['dataParaAgendamento']?></td>
                        <td><?php echo $linha['horarioHoraEntrada']. ' - '. $linha['horarioHoraSaida']?></td>
                        <td><?php echo $linha['nomeUsuario']?></td>
                        <td><?php echo $linha['nomeServico']?></td>
                        <td>
                        <i class=" fas fa-eye" data-bs-toggle="modal" data-bs-target="#servicoModal" onclick="informacao(
                            '<?php echo $linha['nomeServico'] ?>'
                            ,'<?php echo $linha['valorServico'] ?>'
                          ,'<?php echo $linha['capaServico'] ?>'
                          ,'<?php echo $linha['descricaoServico'] ?>'
                          ,'<?php echo $linha['horaServico'] ?>' 
                          )">
                          </i>
                          |
                        <a href="editar-servico.php?servicoId=<?php echo $linha['idServico']?>"><i class=" fas fa-edit"></i> </a>
                          |
                          <i class="fas fa-trash-alt" data-bs-toggle="modal" data-bs-target="#apagarservico" onclick="apagar('<?php echo $linha['idServico'] ?>','<?php echo $linha['nomeServico'] ?>')"></i>
                        </td>
                      </tr>
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row mb-3">
              <hr>
                <h5 class="modal-title mb-3">Dados do serviço</h5>
                <div class="col-md-12">
                <img src="" alt="" id="capaServicoInfo" style="width: 100%;">
                </div>
                <div class="col-md-3">
                  <p>Nome: <span id="nomeServicoInfo"></span></p>
                </div>
                <div class="col-md-3">
                  <p>Hora: <span id="horaServicoInfo"></span></p>
                </div>
                <div class="col-md-3">
                  <p>Valor: <span id="valorServicoInfo"></span></p>
                </div>

                <div class="col-md-12">
                  <p>Descrição: <span id="descricaoServicoInfo"></span></p>
                </div>
              </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="apagarservico" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <form action="vendor/excluir/_excluirServico.php" method="POST">
                <input type="hidden" name="idServicoApagar" id="idServicoApagar">
      ...
      <script>
        function apagar(id, nome) {
          ...
          document.getElementById('idServicoApagar').value = id;
...
<script>
    function informacao(nome,valor,capa,descricao,hora) {

      document.getElementById('nomeServicoInfo').innerHTML = nome;
      document.getElementById('valorServicoInfo').innerHTML = valor;
      document.getElementById('descricaoServicoInfo').innerHTML = descricao;
      document.getElementById('horaServicoInfo').innerHTML = hora;
    
      document.getElementById('capaServicoInfo').src = 'assets/images/servicos/' + capa;
