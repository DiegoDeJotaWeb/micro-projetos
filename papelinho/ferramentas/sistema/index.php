<?php require_once "./painel/vendor/_conexao.php";
//criar um usuario administrador
$senha_crip = md5('admin');
//echo $senha_crip;

$query = $pdo->query("select * from tb_usuario where adminUsuario = 'Sim'");
...
if ($total_result == 0) {
    $pdo->query('INSERT INTO tb_usuario(nomeUsuario,dtNascimentoUsuario,cpfUsuario,rgUsuario,emailUsuario,telefoneUsuario,
    celularUsuario,dtAdmissaoUsuario,cargoUsuario,adminUsuario,bancoUsuario,tipoContaUsuario,contaUsuario,agenciaUsuario,
    pixUsuario,cepUsuario,enderecoUsuario,bairroUsuario,cidadeUsuario,fotoUsuario,senhaUsuario,
    observacaoUsuario)
    values("Aterar","0000-00-00","000.000.000-00","00.000.000-x","altera@email.com.br","(11)0000-0000",
    "(11)00000-0000","0000-00-00","Alterar cargo","sim","Alterar Conta","Corrente","Alter numero da conta","Alterar agencia",
    "Alterar Pix","00000-000","Alterar logradouro","Alterar Bairro","Alterar Cidade","logo.jpg","1234",
    "Alterar observação");');
}
...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="16x16" href="painel/ssets/images/favicon.png" />
  <!-- Custom CSS -->
  <link href="painel/dist/css/style.min.css" rel="stylesheet" />
...
<body>
        ...
        <div class="h-100 d-flex align-items-center justify-content-center">
          <div class="row justify-content-center text-center">
            <div class="col-md-7 col-lg-12 col-xl-9">
              <div>
                <span class="db"><img src="painel/assets/images/logo-light-icon.png" alt="logo" /></span>
                <span class="db"><img src="painel/assets/images/logo-light-text.png" alt="logo" /></span>
              </div>
              <h2 class="text-white mt-4 fw-light">
                Build
                <span class="font-weight-medium">Fast & Responsive</span> Web
                Apps with Bootstrap 5
              </h2>
          ...
          <div class="col-lg-6 col-xl-3 col-md-7">
            <div class="card" id="registerform">
              <div class="card-body">
                ...
                Insira os detalhes fornecidos para a nova conta
                </p>
            ...
            <div class="card" id="loginform">
              <div class="card-body">
                <h2>Bem-vindo ao Digital Space SW admin</h2>
                <p class="text-muted fs-4">
                  Novo aqui?
                  <a href="javascript:void(0)" id="to-register">Crie a sua conta aqui</a>
                </p>
                <form class="form-horizontal mt-4 pt-4 needs-validation" novalidate action="autenticar.php" method="POST">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control form-input-bg" id="tb-email" placeholder="name@example.com" name="usuario" required />
                    <label for="tb-email">Email</label>
                    <div class="invalid-feedback">Email is required</div>
                  </div>

                  <div class="form-floating mb-3">
                    <input type="password" class="form-control form-input-bg" id="text-password" placeholder="*****" name="senha" required />
                  ...
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                      <a href="javascript:void(0)" id="to-recover" class="fw-bold">Esqueceu a senha?</a>
                    </div>
                  </div>
  ...
  <!-- All Required js -->
  <!-- -------------------------------------------------------------- -->
  <script src="painel/assets/libs/jquery/dist/jquery.min.js"></script>
  <!-- Bootstrap tether Core JavaScript -->
  <script src="painel/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <script>
    $(".preloader").fadeOut();
    // ---------------------------
